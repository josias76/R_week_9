...
summary(select(ebola_wa, starts_with("date")))
```
...
```{r}
ggplot(ebola_wa, aes(x = date_of_hospitalisation)) +
...
```{r}
ggplot(ebola_wa, aes(x = date_of_hospitalisation)) +
  geom_histogram(binwidth = 7, fill = "tomato", color = "white")
```
...
ggplot(ebola_wa, aes(x = date_of_hospitalisation)) +
  ...
  labs(title = "Distribution des hospitalisations Ebola",
...
```{r}
ggplot(ebola_wa, aes(x = date_of_hospitalisation)) +
  geom_histogram(binwidth = 7, fill = "purple", color = "white") +
  scale_x_date(date_breaks = "2 months", date_labels = "%b %y") +
  labs(title = "Hospitalisations Ebola (2014-2015)",
       x = "Date",
       y = "Nombre de cas")
```
...
```{r}
ggplot(ebola_wa_summary, aes(x = date_of_onset, y = n, color = outcome)) +
  geom_line()
```
...
ggplot(ebola_wa_summary, aes(x = date_of_onset, y = n, color = outcome)) +
  ...
  scale_x_date(date_breaks = "2 months", date_labels = "%b %y") +
  labs(title = "Incidence Ebola par date d'apparition des symptômes",
       subtitle = "Afrique de l'Ouest, 2014-2015",
       x = "Date d'apparition",
       y = "Nombre de cas",
       color = "Résultat") +
  theme_minimal()
...
ggplot(ebola_wa_summary, aes(x = date_of_onset, y = n, color = outcome)) +
  geom_line(size = 1.2, alpha = 0.8) +
  scale_x_date(date_breaks = "2 months", date_labels = "%b %y") +
  scale_color_manual(values = c("Death" = "red", "Recover" = "darkgreen")) +
  labs(title = "Cas Ebola par issue clinique",
       x = "Date d'apparition",
       y = "Nombre de cas",
       color = "Résultat")
...
ggplot(ebola_wa_summary, aes(x = date_of_onset, y = n, color = outcome)) +
  ...
  labs(title = "Cas Ebola par issue clinique (palette Set1)",
       x = "Date d'apparition",
       y = "Nombre de cas",
       color = "Résultat")
